...
### Step 1: Create Environment Manager Actions

```bash
php artisan make:action Env/ReadEnvFile --no-interaction
php artisan make:action Env/WriteEnvFile --no-interaction
php artisan make:action Env/BackupnvFile --no-interaction
php artisan make:action Env/ValidateEnvFile --no-interaction
php artisan make:action Env/CompareEnvFiles --no-interaction
```
...
```typescript
// resources/js/components/env-variable-form.tsx
```
...
```typescript
// resources/js/components/sync-env-dialog.tsx
```
...
```typescript
// resources/js/components/env-comparison.tsx
```
