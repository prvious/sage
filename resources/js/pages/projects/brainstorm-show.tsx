...
export default function BrainstormShow({
    project,
    brainstorm,
}: BrainstormShowProps) {
                ...
                <div className="p-6 space-y-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground mt-1">
                                Brainstorm Session - {createdDate}
                            </p>
                        </div>
                    </div>
                    ...
                    {brainstorm.status === "pending" && (
                        <Card className="p-6 text-center">
                            ...
                            <p className="text-sm text-muted-foreground">
                                This brainstorm session will be processed soon.
                                Check back later for generated ideas.
                            </p>
                        </Card>
                    )}
                    ...
                    {brainstorm.status === "processing" && (
                        <Card className="p-6 text-center">
                            ...
                            <p className="text-sm text-muted-foreground">
                                AI is working on generating creative ideas for
                                you.
                            </p>
                        </Card>
                    )}
