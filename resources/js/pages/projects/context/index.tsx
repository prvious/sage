...
export default function Index({ files, project }: ContextIndexProps) {
    ...
    const handleDelete = () => {
        ...
        router.delete(`/projects/${project.id}/context/${fileToDelete}`, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const handleAggregate = () => {
        setAggregating(true);
        router.post(
            `/projects/${project.id}/context/aggregate`,
            {},
            {
                preserveScroll: true,
                onFinish: () => {
