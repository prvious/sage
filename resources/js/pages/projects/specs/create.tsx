            ...
            <AppLayout>
                <div className='p-6 space-y-6'>
                    <div>
                        ...
                        <p className='text-muted-foreground mt-2'>Generate a new feature specification for {project.name}</p>
                    </div>
                    {/* TODO: Add spec creation form */}
                    <div className='text-muted-foreground'>Spec creation form coming soon...</div>
                </div>
            </AppLayout>
        </>
    );
