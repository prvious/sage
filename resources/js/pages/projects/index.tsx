                        ...
                        <div className="flex min-h-150 flex-col items-center justify-center text-center">
                            {searchQuery ? (
                                ...
                                <>
                                    ...
                                    <p className="text-muted-foreground mt-2 max-w-sm">
                                        Get started by adding your first Laravel
                                        project to manage worktrees and
                                        deployments
                                    </p>
                                    <Button
                                        className="mt-4"
                        ...
                        <ScrollArea className="h-150">
                            <div className="space-y-4 pr-4">
                                {projects.map((project) => (
                                    <Link
                                        key={project.id}
                                        href={projectDashboard.url(project.id)}
                                            ...
                                            <CardHeader className="pb-3">
                                                <div className="flex items-start justify-between">
                                                    <div className="flex-1">
                                                        ...
                                                        <CardDescription className="line-clamp-1 font-mono text-xs mt-1">
                                                            {project.path}
                                                        </CardDescription>
                                                    </div>
                                                    <Badge
