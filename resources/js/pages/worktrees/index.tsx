            ...
            <AppLayout>
                <div className="p-6 space-y-6">
                    <div className="flex items-center justify-between">
                        ...
                        <Button
                            onClick={() => router.visit(create(project.id).url)}
                        >
                            Create Worktree
                        </Button>
                    </div>
                    ...
                    {worktrees.length === 0 ? (
                        <div className="flex min-h-96 flex-col items-center justify-center text-center">
                            ...
                            <p className="text-muted-foreground mt-2 max-w-sm">
                                Create your first worktree to work on a feature
                                branch with its own preview URL.
                            </p>
                            <Button
                                className="mt-4"
                                onClick={() =>
                                    router.visit(create(project.id).url)
                                }
                            >
                                    ...
                                    <Card className="transition-all hover:shadow-lg hover:border-primary h-full">
                                        ...
                                        <CardContent className="space-y-3">
                                            ...
                                            {worktree.error_message && (
                                                <p
                                                    className="text-sm text-destructive line-clamp-2"
                                                    title={
                                                        worktree.error_message
                                                    }
                                                >
