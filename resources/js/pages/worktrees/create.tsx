                ...
                <div className="p-6 space-y-6">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2">
                            Set up a new Git worktree with an isolated
                            environment for your feature branch.
                        </p>
                    </div>
                                ...
                                <FieldSet className="space-y-6">
                                    <FieldGroup>
                                        <Field>
                                            ...
                                            />
                                            <FieldDescription>
                                                Enter the branch name for this
                                                worktree
                                            </FieldDescription>
                                            {errors.branch_name && (
                                        ...
                                        <Field>
                                            <div className="flex items-center gap-2">
                                                ...
                                                />
                                                <FieldLabel
                                                    htmlFor="create_branch"
                                                    className="!mt-0"
                                                >
                                                    Create branch if it doesn't
                                                    exist
                                                </FieldLabel>
                                            </div>
                                            <FieldDescription>
                                                Check this to automatically
                                                create the branch if it doesn't
                                                already exist in your repository
                                            </FieldDescription>
                                        </Field>
