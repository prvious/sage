...
type FetchFunction = {
    ...
    json: <T = unknown>(url: RequestInfo | URL, init?: UseFetchOptions) => Promise<T>;
    post: (url: RequestInfo | URL, body?: unknown, init?: UseFetchOptions) => Promise<Response>;
    put: (url: RequestInfo | URL, body?: unknown, init?: UseFetchOptions) => Promise<Response>;
    patch: (url: RequestInfo | URL, body?: unknown, init?: UseFetchOptions) => Promise<Response>;
    delete: (url: RequestInfo | URL, init?: UseFetchOptions) => Promise<Response>;
};
