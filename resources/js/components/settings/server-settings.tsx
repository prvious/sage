        ...
        <div className="space-y-6">
            ...
            <Card>
                ...
                <CardContent>
                    <Form
                        method="put"
                        action={`/projects/${project.id}/settings`}
                    >
                        {({ errors, processing }) => (
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <Label htmlFor="server_port">
                                ...
                                <div className="flex items-center justify-between space-x-2">
                                    <div className="space-y-0.5">
                                        <Label htmlFor="tls_enabled">
                                            Enable TLS/HTTPS
                                        </Label>
                                        <p className="text-sm text-muted-foreground">
                                            Automatically enable HTTPS for this
                                            project
                                        </p>
                                    </div>
                                    <Switch
                                        id="tls_enabled"
                                        name="tls_enabled"
                                        defaultChecked={project.tls_enabled}
                                    />
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Use a custom domain instead of the base
                                        URL
                                    </p>
                                </div>

                                <div className="space-y-2">
                                    <Label htmlFor="custom_directives">
                                        Custom Server Directives (optional)
                                    </Label>
                                    <Textarea
                                        id="custom_directives"
                                        name="custom_directives"
                                        defaultValue={
                                            project.custom_directives || ""
                                        }
                                        placeholder="Add custom server directives here..."
                                        rows={6}
                                    />
                                    {errors.custom_directives && (
                                        <p className="text-sm text-destructive">
                                            {errors.custom_directives}
                                        </p>
                                    )}
                                    <p className="text-sm text-muted-foreground">
                                        Add custom configuration directives for
                                        your server
                                    </p>
                                </div>
