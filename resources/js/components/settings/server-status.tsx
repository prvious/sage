    ...
    const handleTestServer = async () => {
        ...
        try {
            const response = await fetch(
                `/projects/${projectId}/settings/test-server`,
                {
                    method: "POST",
                    headers: {
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Current server driver status and configuration
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div className="flex gap-2">
                    <Button
                        ...
                        disabled={isTesting || !serverStatus.installed}
                    >
                    ...
                    <Button
                        ...
                        disabled={isRegenerating || !serverStatus.installed}
                    >
